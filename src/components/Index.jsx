...
// Las variantes WebP y las dimensiones reales salen del manifiesto que genera
// scripts/optimize-images.mjs, para no escribirlas a mano.
...
].map((slide) => ({ ...slide, ...bySrc[slide.url] }));
    ...
    <>
      <section className='hero_index'>
        <div className="hero_index-card">
          <picture className='logo'>
            ...
            <img width={250} height={250} src="/logo.png" fetchPriority="high" alt="Escuela Tai Jitsu Uruguay Logo" />
          </picture>
          <div className="text">
      ...
      <section className='section_services'>
        ...
        <article className='service-grid'>
          {slides.map((slide) => (
            <div className='slide-card' key={slide.url}>
              <picture>
                <source srcSet={slide.sm} type='image/webp' />
                <img
                  src={slide.url}
                  width={slide.w}
                  height={slide.h}
